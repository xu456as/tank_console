...
public interface InviteMapper {
    void save(@Param("inviterId") Long inviterId, @Param("inviteeId") Long inviteeId, @Param("roomId")Long roomId, @Param("date")Long date, @Param("duration")Long duration, @Param("state")Integer state);
